...
const Banner = () => {
    return (
                ...
                <div className="hero mb-12 lg:mb-24">
                    <div className="w-10/12 bg-gray-200 text-black flex flex-col justify-between items-center lg:flex-row-reverse p-12 rounded-xl">
                        ...
                        <div className="text-center lg:text-left space-y-8">
                            ...
                            <button className="btn shadow-none border-none bg-[#23BE0A] text-white">View The List</button>
                        </div>
                    </div>
                </div>
