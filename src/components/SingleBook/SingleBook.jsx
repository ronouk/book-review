            ...
            <div className="flex flex-col lg:flex-row gap-12">
                ...
                <div className="lg:w-1/2">
                    ...
                    <div className="flex gap-4">
                        <button onClick={handleAddtoRead} className="btn bg-transparent border-2 shadow-none border-[#1313134D] hover:text-white hover:bg-green-700">Mark as Read</button>
                        <button onClick={handleAddToWishlist} className="btn bg-[#50B1C9] text-white hover:bg-amber-600">Add to Wishlist</button>
                    </div>
                </div>
            </div>
